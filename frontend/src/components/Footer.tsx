...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <a href="#" className="text-xl lg:text-xl font-serif text-pink-600">
          <span>BARIQ</span>
        </a>
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3">
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Design Your Charm</a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Shop Collection </a>
            </li>
        ...
        <div>
          ...
          <p className="font-small text-gray-700 py-5">Subscribe to receive updates, access to exclusive deals, and more.</p>
        </div>
    ...
    <p className="text-xs text-gray-500 text-center">&copy; 2025. BARIQ. All rights reserved.</p>
  </div>
</footer>
