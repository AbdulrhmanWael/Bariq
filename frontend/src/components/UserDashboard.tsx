...
const DesignCard: React.FC<DesignCardProps> = ({ design, onEdit }) => {
  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
      <div className="relative">
        ...
        />
        <span className={`absolute top-4 right-4 px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(design.status)}`}>
          {design.status}
        </span>
      </div>
