        ...
        <div className="mt-8 mx-auto w-full max-w-md ">
          ...
          <div className="mt-6">
            ...
            <div className=" flex justify-center text-md">
              <span className="py-5 ">Already have an account?</span>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 w-full">
          <div className="flex flex-col items-center text-center space-y-4 py-12">
            ...
            <div>
              ...
              <p className="text-gray-600 max-w-xs py-5">
                Create and save multiple design ideas and return to them
                anytime.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center space-y-4 py-12">
            ...
            <div>
              ...
              <p className="text-gray-600 max-w-xs py-5">
                Easily view and track all your past and current orders in one
                place.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center space-y-4 py-12">
            ...
            <div>
              ...
              <p className="text-gray-600 max-w-xs py-5">
                Receive special promotions, early access to new designs, and
